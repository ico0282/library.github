				...
				<form method="post" id="categoryForm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><i class="fa fa-plus"></i> Промени</h4>
						</div>
						<div class="modal-body">						
							
							<div class="form-group">							
								<label for="Income" class="control-label">Име на Категория</label>							
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder="category name"/>
												
							</div>
							
							<div class="form-group">
								<label for="country" class="control-label">Статус</label>							
